...
setuptools.setup(
    name="simpleget-UCYT5040", # Put your username here!
    version="0.0.1", # The version of your package!
    author="UCYT5040", # Your name here!
    author_email="email@ucyt.dev", # Your e-mail here!
    description="SimpleGet is a Python module making requests much easier to send with only one line of code.", # A short description here!
